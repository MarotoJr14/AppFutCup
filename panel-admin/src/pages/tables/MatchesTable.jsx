...
export default function MatchesTable() {
  ...
  const COLUMNS = [
    ...
    { key: 'team_home_id',  label: 'Eq. Local',     render: v => teamName(v),  csvRender: v => teamName(v) },
    { key: 'team_away_id',  label: 'Eq. Visitante', render: v => teamName(v),  csvRender: v => teamName(v) },
    { key: 'status',        label: 'Estado' },
    { key: 'goals_home',    label: 'Gol L.',       render: v => v ?? '—' },
    { key: 'goals_away',    label: 'Gol V.',       render: v => v ?? '—' },
