              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: isLoading ? const CircularProgressIndicator(color: AppColors.onPrimary) : const Text(AppStrings.login, style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ),
                const SizedBox(height: 16),
                TextButton(
                ...
                Image.asset('assets/images/futcup2026_banner.png', fit: BoxFit.fitWidth),
              ],
            ),
          ),
        ),
