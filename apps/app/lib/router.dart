...
import 'screens/teams/edit_team_screen.dart';
...
import 'screens/events/add_penalty_event_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/match/:id/add-penalty',
        builder: (_, state) => AddPenaltyEventScreen(matchId: int.parse(state.pathParameters['id']!)),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/team/:id/edit',
        builder: (_, state) => EditTeamScreen(teamId: int.parse(state.pathParameters['id']!)),
      ),
      GoRoute(
        path: '/add-team',
      ...
      GoRoute(
        ...
        builder: (_, state) {
          ...
          final playerId = int.parse(state.pathParameters['id']!);
          if (extra is int) {
            return PlayerDetailScreen(playerId: playerId, tournamentId: extra);
          }
